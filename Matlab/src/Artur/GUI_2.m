...
% Last Modified by GUIDE v2.5 21-Oct-2015 16:42:32
...
% --- Executes on selection change in Calc.
function Calc_Callback(hObject, eventdata, handles)
% hObject    handle to Calc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns Calc contents as cell array
%        contents{get(hObject,'Value')} returns selected item from Calc
