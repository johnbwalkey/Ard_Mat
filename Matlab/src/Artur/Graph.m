...
% Hint: get(hObject,'Value') returns toggle state of j
handles.j_Callback.UserData=hObject.UserData;
...
%input username inputdlg=(input name');
% need to add error tolerance
% --------------------------------------------------------------------
